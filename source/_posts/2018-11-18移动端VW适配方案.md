...
# 二. `vw`适配的兼容性
### 2.1 可使用`viewport`的polyfill方案来完美解决:`postcss-viewport-units`配合[viewport-units-buggyfill](https://github.com/rodneyrehm/viewport-units-buggyfill)
```bash
